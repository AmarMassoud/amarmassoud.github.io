...
const parentElement = document.getElementById('products-header');
  ...
  parentElement.addEventListener('click', function(event) {
    ...
    document.querySelector('#earnings-header').classList.remove('bg-custom-red', 'text-white');
    document.querySelector('#stock-header').classList.remove('bg-custom-red', 'text-white');
    document.querySelector('#price-header').classList.remove('bg-custom-red', 'text-white');
    document.querySelector('#sales-header').classList.remove('bg-custom-red', 'text-white');
    document.querySelector('#category-header').classList.remove('bg-custom-red', 'text-white');
    document.querySelector('#rating-header').classList.remove('bg-custom-red', 'text-white');
    document.querySelector('#product-header').classList.remove('bg-custom-red', 'text-white');
    ...
    const headerText = event.target.textContent.trim().toLowerCase();
        ...
        if (headerText === 'price') {
            ...
            document.querySelector('#price-header').classList.add('bg-custom-red', 'text-white');


        } else if (headerText === 'stock') {
            products.sort((a, b) => direction * (a.stock - b.stock));
            document.querySelector('#stock-header').classList.add('bg-custom-red', 'text-white');
        } else if (headerText === 'earnings') {
            products.sort((a, b) => direction * (a.price * a.stock - b.price * b.stock));
            document.querySelector('#earnings-header').classList.add('bg-custom-red', 'text-white');

        } else if (headerText === 'sales') {
            products.sort((a, b) => direction * (a.stock - b.stock));
            document.querySelector('#sales-header').classList.add('bg-custom-red', 'text-white');

        } else if (headerText === 'category') {
            products.sort((a, b) => direction * a.category.localeCompare(b.category));
            document.querySelector('#category-header').classList.add('bg-custom-red', 'text-white');

        } else if (headerText === 'rating') {
            document.querySelector('#rating-header').classList.add('bg-custom-red', 'text-white');
            ...
            document.querySelector('#product-header').classList.add('bg-custom-red', 'text-white');
